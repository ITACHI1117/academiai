  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <div className="bg-card rounded-2xl shadow-xs border p-8 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
          ...
          <button
            ...
            className="cursor-pointer w-full bg-primary text-primary-foreground py-4 px-6 rounded-xl font-semibold hover:bg-primary/90 transition-all duration-200 transform hover:scale-[1.02] shadow-xs hover:shadow-sm"
          >
            Start Conversation
        ...
        <div className="bg-card rounded-2xl shadow-xs border p-8 hover:shadow-md transition-all duration-300 transform hover:-translate-y-1">
          ...
          <button
            ...
            className="w-full bg-muted border-2 border-border text-muted-foreground py-4 px-6 rounded-xl font-semibold cursor-not-allowed opacity-75"
            disabled
          >
            Continue Session
      ...
      <div className="mt-16 text-center">
        <div className="bg-card/60 backdrop-blur-sm rounded-2xl border p-8 max-w-2xl mx-auto">
